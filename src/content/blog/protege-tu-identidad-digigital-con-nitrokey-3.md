...
showHeroImage: true
tags: ["seguridad", "privacidad", "hardware"]
lang: es
draft: false
---
...
Permite iniciar sesión sin contraseña (_passwordless_) o como segundo factor reforzado. Compatible con Google, GitHub, Microsoft, Twitter, servicios cloud y plataformas corporativas.
...
Las claves residen en un _secure element_ interno, aisladas del sistema operativo. Aunque tu ordenador esté comprometido, no pueden ser extraídas.
...
Si tu prioridad es la transparencia, la auditabilidad y el software libre, **Nitrokey 3 es la mejor elección**.
Si necesitas compatibilidad empresarial masiva o usas servicios muy específicos, **YubiKey puede ser la opción más completa**.
...
| Almacenamiento seguro | Claves privadas en _secure element_         |
...
[Nitrokey 3: The Secure Key to Your Digital Life](https://www.nitrokey.com/files/doc/Nitrokey_3_factsheet.pdf)
...
- [Nitrokey Documentation](https://docs.nitrokey.com/nitrokeys/)
